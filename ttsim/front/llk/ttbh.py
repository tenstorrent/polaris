...
def instruction_kind() -> decoded_instruction.instruction_kind:
    return decoded_instruction.instruction_kind.ttbh
...
def decode_instruction (instruction: int, instruction_set: None | decoded_instruction.instruction_kind | str | dict[str, typing.Any] | dict[decoded_instruction.instruction_kind, None | decoded_instruction.instruction_kind | str | dict[str, typing.Any]] = None, is_swizzled: bool = True):
