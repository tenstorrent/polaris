...
class EmbedLayerNormalizationExtOp(SimOp):
    ...
    def get_perf_counts(self, inT, outT, **kwargs):
        ...
        embedding_ops = batch_size * seq_len  # One lookup per token
        ...
        rsqrt_count = batch_size * seq_len if self.normalization_type == 'layer' else 0
        gather_count = batch_size * seq_len  # Embedding lookups
