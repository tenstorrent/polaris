...
class HardswishOp(SimOp):
    ...
    def build(self, inputs):
        # Minimal: just forward the input tensor reference.
        # Shape/dtype propagation happens in get_perf_counts above.
        assert len(inputs) == 1, "Hardswish expects exactly one input"
        return inputs[0]
...
def SimOpFactory(optype: str) -> type[SimOp]:
    cls2optype: Dict[type[SimOp], list[str]] = {
            ...
            ReduceSumOp          : ['ReduceSum'],  # present in main; keep as-is
