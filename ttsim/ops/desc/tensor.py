...
def register_tensor_ops():
    _optbl = [
            ...
            ['Permute',   'ARITY_1->1', 'ai.onnx',  'COMMON',  24,  21,  1,  1,  1,  1, permute_op_inf_func,    True,  True,  True,  True,  True],
            ...
            ['Fold',      'ARITY_1->1', 'ai.onnx',  'COMMON',  24,  21,  1,  1,  1,  1, fold_sinf,  True,  True,  True,  True,  True],
