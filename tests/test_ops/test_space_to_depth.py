...
class TestSpaceToDepth(unittest.TestCase):
    ...
    def test_factory_integration(self):
        """Basic sanity test for SpaceToDepth creation via SimOp."""
        op_info = {
            'name': 'test_space_to_depth_factory',
            'optype': 'SpaceToDepth',
            'inList': ['X'],
            'outList': ['Y'],
            'attrs': {'blocksize': 2},
        ...
        assert op_obj.optype == 'SpaceToDepth'
    ...
    def test_space_to_depth_invalid_inputs(self):
        ...
        # This should raise an error due to invalid input count from desc metadata
