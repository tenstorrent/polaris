...
class TestGlobalMaxPool:
    ...
    def test_factory_integration_global_max_pool(self):
        """Test that GlobalMaxPool is registered in the op mapping"""
        assert get_opdesc_registry().has_shape_inference_function('GlobalMaxPool')
...
class TestGlobalAveragePool:
    ...
    def test_factory_integration_global_average_pool(self):
        """Test that GlobalAveragePool is registered in the op mapping"""
        assert get_opdesc_registry().has_shape_inference_function('GlobalAveragePool')
    ...
    def test_global_pooling_operations_comparison(self):
        ...
        max_pool_op = SimOp(max_pool_op_info)
        ...
        avg_pool_op = SimOp(avg_pool_op_info)
