...
class TestReduceProd:
    ...
    def test_factory_integration(self):
        """Test that ReduceProdOp can be created through SimOpFactory"""
        op_cls = SimOpFactory('ReduceProd')
        assert op_cls.__name__ == 'ReduceProdOp'
    ...
    def test_reduce_prod_with_axes(self):
        ...
        i_tensors = [
            ...
            F._from_shape('axes', [2], np_dtype=np.int64)  # axes tensor
        ]
        o_tensors = [F._from_shape('Y', [2, 3, 4], np_dtype=np.float32)]
