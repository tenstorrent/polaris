...
class TestMatMulInteger:
    ...
    def test_factory_integration(self):
        """Test that MatMulInteger is registered in the op mapping"""
        op_info = {
            'name': 'test_matmulinteger_factory',
    ...
    def test_zero_dimension_handling(self):
        ...
        with pytest.raises(ValueError, match="Shapes must have at least 1 dimension"):
            op.get_perf_counts(inT, outT)
