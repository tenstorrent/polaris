...
import numpy as np
import pytest
from ttsim.ops.op import SimOpFactory, MishOp
...
class TestMish:
    ...
    def test_factory_integration(self):
        """Test that Mish is properly integrated into SimOpFactory"""
        opcls = SimOpFactory('Mish')
        assert opcls == MishOp
    ...
    def test_mish_invalid_tensor_shape(self):
        ...
        with pytest.raises(AssertionError, match="Mish input must be at least 1D"):
    ...
    def test_mish_performance_consistency(self):
        ...
        expected_instrs = ['exp', 'add', 'ln', 'tanh', 'mul']
