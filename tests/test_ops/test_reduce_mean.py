...
class TestReduceMean:
    ...
    def test_factory_integration(self):
        """Test that ReduceMeanOp can be created through SimOpFactory"""
        op_cls = SimOpFactory('ReduceMean')
        assert op_cls.__name__ == 'ReduceMeanOp'
    ...
    def test_reduce_mean_with_axes(self):
        ...
        i_tensors = [
            ...
            F._from_shape('axes', [1], np_dtype=np.int64)  # axes tensor
        ]
        o_tensors = [F._from_shape('Y', [2, 3, 4], np_dtype=np.float32)]
