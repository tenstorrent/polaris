...
class TestFastGelu:
    ...
    def test_factory_integration_fast_gelu(self):
        """Sanity: FastGeluOp class exists"""
        assert get_opdesc_registry().has_shape_inference_function('FastGelu')

    def test_factory_integration_fast_gelu_grad(self):
        """Sanity: FastGeluGradOp class exists"""
        assert get_opdesc_registry().has_shape_inference_function('FastGeluGrad')
    ...
    def test_fast_gelu_vs_gelu_complexity(self):
        ...
        fast_gelu_op = SimOp(fast_gelu_op_info)
