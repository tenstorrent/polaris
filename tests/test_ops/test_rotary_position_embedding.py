...
class TestRotaryPositionEmbedding:
    ...
    def test_factory_integration(self):
        """Sanity: RotaryPositionEmbedding is registered"""
        from ttsim.ops.desc.registry import get_opdesc_registry
        assert get_opdesc_registry().has_shape_inference_function('RotaryPositionEmbedding')
    ...
    def test_llama_style_configuration(self):
        ...
        assert op.attrs['rotary_embedding_dim'] == 64
        assert op.attrs['num_heads'] == 32
