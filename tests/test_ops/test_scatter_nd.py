...
import numpy as np
import pytest
from ttsim.ops.op import SimOpFactory, ScatterNDOp
...
class TestScatterND:
    ...
    def test_factory_integration(self):
        """Test that ScatterND is properly integrated into SimOpFactory"""
        opcls = SimOpFactory('ScatterND')
        assert opcls == ScatterNDOp
    ...
    def test_invalid_input_count(self):
        ...
        with pytest.raises(AssertionError, match="ScatterND expects 3 inputs"):
    ...
    def test_invalid_output_count(self):
        ...
        with pytest.raises(AssertionError, match="ScatterND expects 1 output"):
            op.get_perf_counts(inT, outT)
    ...
    def test_invalid_reduction_mode(self):
        ...
        with pytest.raises(ValueError, match="Invalid reduction mode 'invalid_mode'"):
            ScatterNDOp(op_info)
