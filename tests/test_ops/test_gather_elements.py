...
class TestGatherElements(unittest.TestCase):
    ...
    def test_factory_integration(self):
        """Test that GatherElementsOp is registered in the op mapping"""
        assert get_opdesc_registry().has_shape_inference_function('GatherElements')
    ...
    def test_gather_elements_invalid_inputs(self):
        ...
        with pytest.raises(AssertionError, match="operator should be in range"):
