...
class TestClip(unittest.TestCase):
    ...
    def test_factory_integration(self):
        """Test that ClipOp can be created through SimOpFactory"""
        op_cls = SimOpFactory('Clip')
        assert op_cls.__name__ == 'ClipOp'
    ...
    def test_clip_with_attributes(self):
        ...
        assert op_obj.min_val == 0.0
        assert op_obj.max_val == 1.0
