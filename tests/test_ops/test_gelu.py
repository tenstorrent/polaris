...
def reference_gelu_erf(x):
    """
    Reference implementation of GELU with erf (default variant).
...
class TestGelu:
    ...
    def test_gelu_default_variant(self):
        ...
        assert 'erf' in perf_stats['instrs']     # Should have erf operations for default variant
    ...
    def test_gelu_variant_differences(self):
        ...
        # Default should have erf, tanh should have tanh
        assert 'erf' in perf_stats_default['instrs']
        assert 'erf' not in perf_stats_tanh['instrs']
