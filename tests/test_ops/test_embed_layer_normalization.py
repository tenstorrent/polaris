...
def test_embed_layer_normalization_factory():
    """Test that EmbedLayerNormalization operation is registered in the op mapping"""
    print("\n=== Testing EmbedLayerNormalization Factory Creation ===")
    from ttsim.ops.desc.registry import get_opdesc_registry
    assert get_opdesc_registry().has_shape_inference_function('EmbedLayerNormalization')
