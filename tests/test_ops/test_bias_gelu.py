...
class TestBiasGelu:
    ...
    def test_factory_integration(self):
        """Sanity: BiasGelu class exists (not in descriptor registry)"""
        assert get_opdesc_registry().has_shape_inference_function('BiasGelu')
    ...
    def test_bias_gelu_vs_separate_operations(self):
        ...
        bias_gelu_op = SimOp(bias_gelu_op_info)
