...
class TestSimplifiedLayerNormalization:
    ...
    def test_factory_integration(self):
        """Basic sanity test for SimplifiedLayerNormalization creation via SimOp."""
        op_info = {
            'name': 'test_simplified_layernorm_factory',
        ...
        op = SimOp(op_info)
        assert op.optype == 'SimplifiedLayerNormalization'
