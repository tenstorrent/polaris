...
def test_rms_normalization_basic():
    ...
    print(f"  Axis: {op_obj.attrs['axis']}")
...
def test_rms_normalization_factory():
    """Test that RMSNormalization operation is registered in the op mapping"""
    print("\n=== Testing RMSNormalization Factory Creation ===")
    from ttsim.ops.desc.registry import get_opdesc_registry
    assert get_opdesc_registry().has_shape_inference_function('RMSNormalization')
