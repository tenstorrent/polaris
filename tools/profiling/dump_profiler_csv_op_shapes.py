...
_PROFILING_DIR = Path(__file__).resolve().parent
for _p in (_REPO_ROOT, _PROFILING_DIR):
    if str(_p) not in sys.path:
        sys.path.insert(0, str(_p))

from profiler_to_polaris_converter import parse_tensor_dimensions  # noqa: E402

import profiler_polaris_opname_mapping as _ppm  # noqa: E402
