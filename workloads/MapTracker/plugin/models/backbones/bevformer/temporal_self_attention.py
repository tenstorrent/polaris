    ...
    def __call__(
        ...
        **kwargs,
        ...
        if value is None:
            ...
            _data_value_unsqueeze_axis = F._from_data(
            ...
            _data_value_tile_reps = F._from_data(
            ...
            _data_value_reshape_shape = F._from_data(
        ...
        _data_value_input_flatten_shape = F._from_data(
            self.name + ".value_input_flatten_shape",
            np.array([bs * self.num_bev_queue, num_value, embed_dims], dtype=np.int64),
            is_const=True,
        )
        setattr(
            self, _data_value_input_flatten_shape.name, _data_value_input_flatten_shape
        )
        ...
        if key_padding_mask is not None:
            ...
            _data_mask_expand_axis = F._from_data(
        ...
        _data_value_reshape_heads_shape = F._from_data(
        ...
        setattr(
            self, _data_value_reshape_heads_shape.name, _data_value_reshape_heads_shape
        )
        ...
        _data_sampling_offsets_reshape_shape = F._from_data(
        ...
        setattr(
            self,
            _data_sampling_offsets_reshape_shape.name,
            _data_sampling_offsets_reshape_shape,
        )
        ...
        _data_attention_weights_reshape_shape = F._from_data(
        ...
        setattr(
            self,
            _data_attention_weights_reshape_shape.name,
            _data_attention_weights_reshape_shape,
        )
        _op = F.Reshape(self.name + ".attention_weights_reshape")
        setattr(self, _op.name, _op)
        attention_weights = _op(
            attention_weights, _data_attention_weights_reshape_shape
        )
        setattr(self, attention_weights.name, attention_weights)
        ...
        _data_attention_weights_reshape2_shape = F._from_data(
        ...
        setattr(
            self,
            _data_attention_weights_reshape2_shape.name,
            _data_attention_weights_reshape2_shape,
        )
        _op = F.Reshape(self.name + ".attention_weights_reshape2")
        setattr(self, _op.name, _op)
        attention_weights = _op(
            attention_weights, _data_attention_weights_reshape2_shape
        )
        setattr(self, attention_weights.name, attention_weights)
        ...
        _data_attention_weights_reshape3_shape = F._from_data(
        ...
        setattr(
            self,
            _data_attention_weights_reshape3_shape.name,
            _data_attention_weights_reshape3_shape,
        )
        _op = F.Reshape(self.name + ".attention_weights_reshape3")
        setattr(self, _op.name, _op)
        attention_weights = _op(
            attention_weights, _data_attention_weights_reshape3_shape
        )
        setattr(self, attention_weights.name, attention_weights)
        ...
        _data_sampling_offsets_reshape2_shape = F._from_data(
        ...
        setattr(
            self,
            _data_sampling_offsets_reshape2_shape.name,
            _data_sampling_offsets_reshape2_shape,
        )
        ...
        if reference_points.shape[-1] == 2:
            ...
            _data_ref_points_exp1_axis = F._from_data(
            ...
            _data_ref_points_exp2_axis = F._from_data(
            ...
            _data_offset_norm_exp1_axis = F._from_data(
            ...
            setattr(self, _op.name, _op)
            offset_normalizer_expanded = _op(
                offset_normalizer, _data_offset_norm_exp1_axis
            )
            setattr(self, offset_normalizer_expanded.name, offset_normalizer_expanded)
            _data_offset_norm_exp2_axis = F._from_data(
            ...
            setattr(self, _op.name, _op)
            offset_normalizer_expanded = _op(
                offset_normalizer_expanded, _data_offset_norm_exp2_axis
            )
            setattr(self, offset_normalizer_expanded.name, offset_normalizer_expanded)
            _data_offset_norm_exp3_axis = F._from_data(
            ...
            setattr(self, _op.name, _op)
            offset_normalizer_expanded = _op(
                offset_normalizer_expanded, _data_offset_norm_exp3_axis
            )
            setattr(self, offset_normalizer_expanded.name, offset_normalizer_expanded)
            _data_offset_norm_exp4_axis = F._from_data(
            ...
            setattr(self, _op.name, _op)
            offset_normalizer_expanded = _op(
                offset_normalizer_expanded, _data_offset_norm_exp4_axis
            )
            setattr(self, offset_normalizer_expanded.name, offset_normalizer_expanded)
            ...
            setattr(self, _op.name, _op)
            sampling_offsets_normalized = _op(
        ...
        _data_output_reshape1_shape = F._from_data(
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"  [OK] TemporalSelfAttention constructed successfully")
        ...
        print(f"  [X] TemporalSelfAttention construction failed: {e}")
        import traceback
