...
``vit_test_infra_polaris.py`` (Wormhole) but pulls config and parameters
...
import workloads.ttnn.vit.ttnn_optimized_sharded_vit_bh as ttnn_optimized_sharded_vit
from workloads.ttnn.vit.vit_polaris_params_bh import (
    config_dict,
    config_obj,
