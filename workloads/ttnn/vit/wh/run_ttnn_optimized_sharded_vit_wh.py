...
if not IS_POLARIS:
    ...
    import workloads.ttnn.vit.wh.ttnn_optimized_sharded_vit_wh as ttnn_optimized_sharded_vit
...
if not IS_POLARIS:
    ...
    from models.demos.vision.classification.vit.wormhole.tt import (   # type: ignore[import] # noqa F401, E402
        ttnn_optimized_sharded_vit_wh as ttnn_optimized_sharded_vit,  # type: ignore[no-redef]
    )
    from tests.ttnn.utils_for_testing import assert_with_pcc   # type: ignore[import] # noqa F401, E402

if IS_POLARIS:
    from workloads.ttnn.vit.wh.vit_polaris_params_wh import (  # noqa: E402
        config_dict,
        config_obj,
...
def standalone(test_name: str | None = None) -> None:
    """Run all standalone optimized sharded ViT tests, or a single test by short name."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run optimized sharded ViT (Wormhole) standalone tests."
    )
    parser.add_argument(
        "test",
        nargs="?",
