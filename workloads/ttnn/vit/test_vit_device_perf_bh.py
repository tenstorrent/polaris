...
if not IS_POLARIS:
    ...
    from workloads.ttnn.vit.vit_test_infra_polaris_bh import create_test_infra  # type: ignore[no-redef]
    from workloads.ttnn.vit.vit_polaris_params_bh import config_dict
