...
if not IS_POLARIS:
    ...
    from workloads.ttnn.vit.vit_test_infra_polaris import create_test_infra  # type: ignore[no-redef]
    from workloads.ttnn.vit.vit_polaris_params import config_dict
