...
from workloads.ttnn.vadv2.tt.tt_bottleneck import TtBottleneck
...
class TtResnet50:
    ...
    def __call__(self, x, batch_size=1):
        ...
        # print(f'maxpool args {self.maxpool_args.batch_size}, {self.maxpool_args.input_height}, {self.maxpool_args.input_width}')
        # print(f'kernel_size {self.maxpool_args.kernel_size}, stride {self.maxpool_args.stride}, padding {self.maxpool_args.padding}, dilation {self.maxpool_args.dilation}')
        x = ttnn.max_pool2d(
            input_tensor=x,
