...
Direct port from TT-Metal test_decoder_inference.py
"""
import os
import sys
import traceback
...
def test_decoder_inference(wln, device, cfg, **kwargs):
    ...
    # Summary
    logger.info(f"\n{'=' * 40}")
    logger.info(f"Decode Test Summary:")
