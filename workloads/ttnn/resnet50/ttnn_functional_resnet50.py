...
class resnet50:
    def __init__(
        ...
        # Calling ttnn.from_torch() on a tensor that was created with ttnn._rand() (line 740) is incorrect. 
        # The tensor is already a ttnn tensor, not a torch tensor. This line should be removed
        #  or the tensor creation should use torch instead.
