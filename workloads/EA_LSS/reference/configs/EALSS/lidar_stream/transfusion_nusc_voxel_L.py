...
log_level = 'INFO'
load_from = None
resume_from = None  # 'work_dirs/lidar_trainval1/lidar_trainval1/epoch_15.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 8)

checkpoint_config = dict(interval=1, out_dir='./work_dirs/lidar_trainval_0.075')
work_dir = './work_dirs/lidar_trainval_0.075'
