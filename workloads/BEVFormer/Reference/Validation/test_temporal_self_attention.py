...
def copy_pytorch_weights_to_ttsim(pytorch_module, ttsim_module):
    ...
    weight_np = pytorch_module.sampling_offsets.weight.detach().cpu().numpy().T
    ...
    weight_np = pytorch_module.attention_weights.weight.detach().cpu().numpy().T
    ...
    # Copy value_proj
    weight_np = pytorch_module.value_proj.weight.detach().cpu().numpy().T
    ...
    # Copy output_proj
    weight_np = pytorch_module.output_proj.weight.detach().cpu().numpy().T
