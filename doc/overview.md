...
4. [Configuration and Mapping](#configuration-and-mapping)
...
#### `TensorMemoryLayout`, `ShardStrategy` (`front/ttnn/buffer.py`)

**Purpose**: Enumerations for tensor memory layouts and sharding strategies.
...
**Purpose**: Utilities for data type conversion and byte-per-element calculations.
